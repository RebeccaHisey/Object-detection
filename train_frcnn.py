...
plt.plot([i for i in range(1,len(all_train_rpn_cls_loss) + 1)], all_train_rpn_cls_loss, 'b', label='Training RPN Class Loss')
plt.plot([i for i in range(1,len(all_val_rpn_cls_loss)+1)], all_val_rpn_cls_loss, '--b', label='Validation RPN Class Loss')
plt.plot([i for i in range(1,len(all_train_rpn_reg_loss)+1)], all_train_rpn_reg_loss, 'r', label='Training RPN Reg Loss')
plt.plot([i for i in range(1,len(all_val_rpn_reg_loss)+1)], all_val_rpn_reg_loss, '--r', label='Validation RPN Reg Loss')
plt.plot([i for i in range(1,len(all_train_cls_cls_loss)+1)], all_train_cls_cls_loss, 'g', label='Training Classifier Class Loss')
plt.plot([i for i in range(1,len(all_val_cls_cls_loss)+1)], all_val_cls_cls_loss, '--g', label='Validation Classifier Class Loss')
plt.plot([i for i in range(1,len(all_train_cls_reg_loss)+1)], all_train_cls_reg_loss, 'c', label='Training Classifier Reg Loss')
plt.plot([i for i in range(1,len(all_val_cls_reg_loss)+1)], all_val_cls_reg_loss, '--c', label='Validation Classifier Reg Loss')
plt.plot([i for i in range(1,len(all_train_total_loss)+1)], all_train_total_loss, 'm', label='Training Classifier Reg Loss')
plt.plot([i for i in range(1,len(all_val_total_loss)+1)], all_val_total_loss, '--m', label='Validation Classifier Reg Loss')
